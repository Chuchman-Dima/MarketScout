...
* **Оцінка поточної ринкової вартості:** Користувач вводить ключові характеристики автомобіля (марка, модель, рік випуску, пробіг, тип палива тощо), а ML-модель (CatBoost) миттєво розраховує його справедливу ціну на основі актуальних ринкових даних.
* **Прогнозування знецінення:** Унікальна фіча проєкту — симуляція падіння ціни авто на найближчі 5 років. Модель враховує як старіння автомобіля, так і орієнтовний щорічний приріст пробігу.
* **Візуалізація трендів:**  Інтерактивні графіки, які наочно показують криву знецінення, допомагаючи зрозуміти, наскільки вигідно інвестувати в конкретне авто.

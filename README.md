...
**Метрики ефективності моделі (CatBoostRegressor)**

* **$R^2$ (Коефіцієнт детермінації): 0.8545** *Модель успішно пояснює 85.5% коливань цін на авторинку. Решта 14.5% припадає на невідомі моделі параметри (стан салону, історія ДТП, терміновість продажу).*
  
* **MAE (Середня абсолютна помилка): 3166.87 USD** *У середньому модель помиляється на ~$3.1k. Оскільки для дешевих та дорогих авто ця помилка сприймається по-різному, у додатку реалізовано вивід цінового діапазону (від мін. до макс. ринкової ціни) замість однієї цифри.*
